...
<!-- START HEAD SECTION ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --><head>
		...
		<link href="css/max665.css" rel="stylesheet" media="screen and (max-width:665px)">
...
<!-- START COUNTDOWN SECTION ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
			<section class="countdown-bg text-center" id="countdown">
				<div class="container">
					<div class="row">
						<div class="clock col-xs-12">
							...
							<h2>Sean Andrew Sobey & Tabitha Michele Wells</h2>
...
<!-- START RESORT SECTION //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
			<section class="resort-bg text-center" id="resort">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<h2>Oceanstone</h2>
						</div>
						<div class="col-md-4 col-xs-10 col-xs-offset-1 where-wrap">
							<h2>Where?</h2>
...
<!-- START FYI SECTION /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
			<section class="fyi-bg text-center" id="fyi">
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-md-6 col-xs-12 fyi-promo">
							<a href="http://www.oceanstoneresort.com/"><img src="img/oceanstonelogo.png" alt="oceanstone logo" style="margin-bottom: 20px;"></a>
							<div class="embed-responsive embed-responsive-16by9">
								<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/haW2qL2YVA8" frameborder="0" allowfullscreen></iframe>
							</div>
						</div>
					</div>
				</div>
...
<!-- START SQUAD SECTION ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
			<section class="no-padding" id="portfolio">
				<div class="wrap-04 container-fluid">
					<div class="row no-gutter text-center">
						<h2>The Bridal Party</h2>
						<h4>In Order of Appearance</h4>
						<h5>( **tap pictures if on touchscreen )</h5>
								...
								<div class="portfolio-box-caption">
									<div class="portfolio-box-caption-content">
										<div class="project-category">
											<h3>Caroline Spindler</h3>	
											<h6>Maid of Honour</h6>
										</div>
					...
					<div class="modal-header">
			  		...
			  		<div class="modal-body">
						<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
							<div class="radio">
								<label><h3>Attending Wedding?</h3><br>
							...
							<hr>
							<div class="radio">
								<label><h3>Are you Attending Friday?</h3><br>
							...
							<hr>
							<div class="textarea">
								<label><h3>You Picky or What?</h3></label>
